<?php
    ...
    // print_r($_SESSION);
    if((!isset($_SESSION['car']) == true) and (!isset($_SESSION['service']) == true))
    {
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM booking WHERE id LIKE '%$data%' or car LIKE '%$data%' or service LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Service Order</a><?php echo $_SESSION["email"]?>
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<td>".$user_data['motorcycle']."</td>";
                        ...
                        <a class='btn btn-sm btn-primary' href='editservice.php?id=$user_data[id]' title='Editar'>
                            ...
                            <a class='btn btn-sm btn-danger' href='deleteservive.php?id=$user_data[id]' title='Deletar'>
...
<script>
    ...
    function searchData()
    {
        window.location = 'serviceorder.php?search='+search.value;
    }
</script>
</html>