<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM users WHERE id LIKE '%$data%' or firstname LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Ger's System</a><?php echo $_SESSION["email"]?>
