<?php
    ...
    {
        $id = $_GET['id'];
        $sqlSelect = "SELECT * FROM booking WHERE id=$id";
        ...
        if($result->num_rows > 0)
        {
            ...
            {
                $car        = $user_data['car'];
                $motorcycle = $user_data['motorcycle'];
                $service    = $user_data['service'];
                $engine     = $user_data['engine'];
                $date       = $user_data['date'];
                $time       = $user_data['time'];
                $licence    = $user_data['licence'];
                $brif       = $user_data['brif_description_of_the_problem'];
...
<body>
    ...
    <a href="serviceorder.php">Back</a>  
    <div class="box">        
        <div class="form-box">
            
            <br>   
            <h2>Book a service</h2>       
            <form action="saveeditservice.php" method="POST">
